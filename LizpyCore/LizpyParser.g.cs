...
namespace Lizpy
{
    ...
    public partial class LizpyParser : Matcher<char, SExpression>
    {
        ...
        public void EscapeSequence(_LizpyParser_Memo _memo, int _index, _LizpyParser_Args _args)
        {
            ...
            {
                _memo.Results.Pop();
                _memo.Results.Push( new _LizpyParser_Item(_r6.StartIndex, _r6.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { return new CharacterExpression('\r', true); }, _r6), true) );
            }
        ...
        label3: // OR
            ...
            {
                _memo.Results.Pop();
                _memo.Results.Push( new _LizpyParser_Item(_r8.StartIndex, _r8.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { return new CharacterExpression('\t', true); }, _r8), true) );
            }
        ...
        label2: // OR
            ...
            {
                _memo.Results.Pop();
                _memo.Results.Push( new _LizpyParser_Item(_r10.StartIndex, _r10.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { return new CharacterExpression('\0', true); }, _r10), true) );
            }
        ...
        label13: // AND
            ...
            {
                _memo.Results.Pop();
                _memo.Results.Push( new _LizpyParser_Item(_r12.StartIndex, _r12.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { return new CharacterExpression(c, true); }, _r12), true) );
            }
        ...
        label1: // AND
            ...
            {
                _memo.Results.Pop();
                _memo.Results.Push( new _LizpyParser_Item(_r0.StartIndex, _r0.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { return new SymbolExpression(s.StartIndex, s.NextIndex, s.InputString(), m.Results.Count() > 0 ? m.ResultAs<MapExpression>() : null); }, _r0), true) );
            }
